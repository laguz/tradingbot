...
def main():
    ...
    parser.add_argument('--quick', action='store_true', help='Run quick test (10 stocks, 3 trials)')
    parser.add_argument('--full', action='store_true', help='Run full experiment (50 stocks, 10 trials)')
    ...
    if args.quick:
        ...
        logger.info("Starting FULL experiment (this may take several hours)")
        ...
        print("Please specify --quick, --full, or --tickers")
        parser.print_help()
        return
